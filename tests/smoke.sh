...
check_readme() {
  ...
  assert_contains "$ROOT/README.md" 'Wallet checkout'
  assert_contains "$ROOT/README.md" 'checkout slots'
  ...
  assert_contains "$ROOT/docs/funnel-qa-checklist.md" 'each wallet method separately'
  assert_contains "$ROOT/docs/funnel-qa-checklist.md" 'offer set'
  assert_contains "$ROOT/docs/funnel-qa-checklist.md" '@funnelsgrove/payments'
...
check_skill() {
  ...
  assert_contains "$skill/SKILL.md" 'Wallet Checkout Lock'
  assert_contains "$skill/SKILL.md" 'ApplePaySubscriptionCheckoutSlot'
  assert_contains "$skill/SKILL.md" 'GooglePaySubscriptionCheckoutSlot'
  assert_contains "$skill/SKILL.md" 'stepContractVersion'
  assert_contains "$skill/SKILL.md" 'offer_set_key'
