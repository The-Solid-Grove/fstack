...
check_skill() {
  ...
  assert_contains "$skill/SKILL.md" 'Pricing Source of Truth'
  assert_contains "$skill/SKILL.md" 'active Stripe price'
  assert_contains "$skill/SKILL.md" 'read-only'
  assert_contains "$ROOT/docs/funnel-qa-checklist.md" 'active Stripe price'
  assert_contains "$ROOT/docs/funnel-qa-checklist.md" 'retired or archived provider price'
